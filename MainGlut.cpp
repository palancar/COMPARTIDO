...
void OnMouseClick(int button, int state, int x, int y); //al pulsar el rat�n
void OnMouseMove(int x, int y); //al mover el rat�n
...
int main(int argc, char* argv[]) {
	...
	glutMouseFunc(OnMouseClick); //al pulsar el rat�n
	glutPassiveMotionFunc(OnMouseMove); //al MOVER el rat�n
